                    ...
                    <form @submit.prevent="sendReviewHunter" @reset.prevent="clearForm" class="review" action="">
                      ...
                      <div class="form-element infoalert alert-danger" role="alert" v-if="response === true">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control"  v-model="review"  id="exampleFormControlTextarea1" rows="3" placeholder="Insert your review" ></textarea>
                        </div>
    ...
    methods: {
        sendReviewHunter(){
            ...
            .catch((error) => {
                console.log(error);
                this.response = false;
                this.errors = error.response.data.surname;
