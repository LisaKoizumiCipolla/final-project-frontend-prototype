          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form @submit.prevent="postHunter" @keyup.enter="postHunter" @reset.prevent="clearForm" class="mx-1 mx-md-4">

                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input type="email" v-model="email" id="form3Example3c" class="form-control mb-1" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" v-model="password1" id="form3Example4c" class="form-control mb-1" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" v-model="password2" id="form3Example4cd" class="form-control mb-1" />
              ...
              <div class="image-container col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                <img src="../../../assets/hunters tooth and talon_intero.png"
...
export default {
    ...
    data() {
        return {
            ...
            password2: '',
            response: null,
            apiUrl: 'http://127.0.0.1:8000/api/sign-in',
        }
    },
    methods: {
        postHunter() {
