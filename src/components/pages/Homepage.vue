<template>
  <div class="wrapper">
    <img class="logo" id="size-mobile" src="../../assets/hunters tooth and talon_intero.png" alt="">
    ...
    <div class="carousel-indicators">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img src="https://wallpaper-mania.com/wp-content/uploads/2018/09/High_resolution_wallpaper_background_ID_77701471456.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="https://www.wallpaperflare.com/static/554/121/81/fantasy-art-warrior-sword-creature-wallpaper.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
  ...
  <div class="contents d-flex flex-column align-items-center">
        ...
        <div class="row justify-content-center">
          ...
          <p class="description text-center">choose one of our best hunters to take care of your enemies
          those are our best hunters according to our customers reviews
          </p>
          </div>
        </div>
        ...
        <div>
          ...
          <select class="select-style px-0" name="type-select" id="type-select" v-model="search">
