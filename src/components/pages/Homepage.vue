<template>
  ...
  <div class="wrapper">
   ...
   <!-- SPONSOPORED SECTION-->
  <div class="bg-sponsorship">
    <div class="container d-flex flex-column align-items-center">

      <div class="row title-sponsored">
        <div class="col-12">
          <h1>
            Let the hunt begin!
          </h1>
        ...
        <!-- CARDS SPONSOPORED -->
        <div class="sponsored row mx-auto">
          <CardContainer />
        </div>
  
  
            <!-- BUTTONS FOR SPONSOR SECTION -->
            <div class="row justifiy-content-center">
                <select class="select-style mx-auto col-10" name="type-select" id="type-select" v-model="search">
